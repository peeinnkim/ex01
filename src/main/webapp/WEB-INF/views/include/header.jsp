                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <c:if test="${Auth == null}">
	                      <a href="${pageContext.request.contextPath}/auth/login" class="btn btn-default btn-flat">Sign in</a>
                      </c:if>
                      <c:if test="${Auth != null}">
	                      <a href="${pageContext.request.contextPath}/auth/logout" class="btn btn-default btn-flat">Sign out</a>
                      </c:if>
                    </div>
                  </li>
                </ul>
