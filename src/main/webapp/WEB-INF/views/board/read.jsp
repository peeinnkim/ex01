		...
		<div class="col-sm-12">
			<div class="box box-primary">
				...
				<div class='box-footer'>
					<div class='btn btn-warning'><a href="modify?bno=${boardVO.bno}" style="color:white;">MODIFY</a></div>
					<div class='btn btn-danger'><a href="remove?bno=${boardVO.bno}" style="color:white;" id="delA">REMOVE</a></div>
					<div class='btn btn-primary'><a href="listAll" style="color:white;">LIST</a></div>
				</div>
